# Aws Clean Room Actor

This actor provides a clean-room, API-compatible implementation of the Aws platform.
...
Relocated 2026-07-04 from `etzhayyim/root/20-actors/aws-compat` to
`kotoba-lang/com-aws` per the org-taxonomy library-placement rule (any
